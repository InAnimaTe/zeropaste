...
/* Return this ZeroPaste server salt.
   This is a random string which is unique to each ZeroBin installation.
   It is automatically created if not present.

   Salt is used:
      - to generate unique VizHash in discussions (which are not reproductible across ZeroPaste servers)
      - to generate unique deletion token (which are not re-usable across ZeroPaste servers)
*/
